    ...
    <div class="container">
        ...
        <form action="<?php echo URL; ?>dashboard/doAdd" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="file" class="form-control-file text-upload font-weight-bold" name="post_file" id="inputFile" 
                        onchange="readUrl(this)" data-title="Click or Drag and drop a file" >
            </div>
